...
setEnv('SESSION_CREATION_SECRET_PREVIOUS', process.env.SESSION_CREATION_SECRET_PREVIOUS);
setEnv('SESSION_COOKIE_SIGNING_SECRET', process.env.SESSION_COOKIE_SIGNING_SECRET);
setEnv(
