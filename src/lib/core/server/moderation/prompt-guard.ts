...
import { assertPromptGuardInputBudget } from './prompt-guard-budget';
 ...
 * @throws when content exceeds the model's reviewed input window
 */
export async function detectPromptInjection(
	...
	assertPromptGuardInputBudget(content);
