...
<div class="space-y-5">
	...
	<!-- Email Health -->
	{#if data.total > 0}
		<div class="flex items-center gap-6 rounded-xl border border-surface-border bg-surface-base px-5 py-3">
	...
	{#if showTagManager && canEdit}
		<div class="rounded-xl bg-surface-base border border-surface-border shadow-[var(--shadow-sm)] p-5 space-y-4">
